...
import * as Flags from './Yaku/Flags.js';
...
export function main(argv) {
    ...
    Flags.IN = opts.i ? 1 : 0;
    Flags.WW = opts.W ? 1 : 0;    // fewer warning and error messages
    Flags.WRS = opts.s ? 1 : 0;   // working and return stack
    Flags.PQ = opts.p ? 1 : 0;    // print and quit
    Flags.EE = opts.e ? 1 : 0;
    Flags.FF = opts.f ? 1 : 0;
    Flags.NSW = opts.S ? 1 : 0;   // no warnings for byte/short mismatch
