...
// 确保所有函数都被导出
export {
    store, load, storeRel, loadRel, call, jump, condJump,
    immediateCall, immediateCondJump, immediateJump, lit, stash,
    pop_, swap, nip, rot, dup, over, add, sub_, mul, div, inc,
    sft, and_, ora, eor, equ, neq, lth, gth, deviceOut, deviceIn
};